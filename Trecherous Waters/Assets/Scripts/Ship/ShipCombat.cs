...
namespace TreacherousWaters
{
    ...
    public class ShipCombat : MonoBehaviour, IFire, ISwitchAmmunition
    {
        ...
        /// <summary>
        /// Maximum delay for individual broadside cannons to fire.
        /// </summary>
        [SerializeField] float maxBroadsideJitter = 0.3f;
        ...
        {
            yield return new WaitForSeconds(Random.Range(0, maxBroadsideJitter));
