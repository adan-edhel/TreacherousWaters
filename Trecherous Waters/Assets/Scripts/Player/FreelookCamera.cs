...
namespace TreacherousWaters
{
    ...
    /// </summary>
    public class FreelookCamera : MonoBehaviour, ICameraControls
    {
        /// <summary>
        /// Singleton reference of the interface through which input is received.
        /// </summary>
        public static ICameraControls iCameraInput { get; private set; }
        ...
        private void Awake()
        {
            iCameraInput = GetComponent<ICameraControls>();
